...
/**
        ...
        */
    public class TaskTitleTextView extends AppCompatTextView {
        public static final int NORMAL = 0;
        public static final int DONE = 1;
        public static final int OVERDUE = 2;
        private int mState;

        public TaskTitleTextView(Context context, AttributeSet attrs, int defStyleAttr) {
            super(context, attrs, defStyleAttr);
        }

        public TaskTitleTextView(Context context, AttributeSet attrs) {
            super(context, attrs);
        }
         ...
         * Normal shows black text.
         * Overdue displays in red.
         * Completed draws a strikethrough line on the text.
         *
         * @param state New state (NORMAL, DONE, OVERDUE}.
         */
