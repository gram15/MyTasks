...
import com.gram15.am.mytasks.alarms.TaskAlarmService;
...
public class TaskService extends IntentService {
    ...
    private void performInsert(ContentValues values) {
        if (getContentResolver().insert(DbContract.CONTENT_URI, values) != null) {
    ...
    private void performDelete(Uri uri) {
        ...
        PendingIntent operation =
                TaskAlarmService.getReminderPendingIntent(this, uri);
